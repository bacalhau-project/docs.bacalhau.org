        ...
        <div className="explanation">
          <div style={{padding: '10px'}}>
            ...
            <div className="explanation-step">
              ...
              <div className="items">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Python-logo-notext.svg/1200px-Python-logo-notext.svg.png" width={60} height={70} />
                <img src="https://linube.com/blog/wp-content/uploads/bash-logo.png" width={60} height={70} />
              </div>
            </div>
            <div className="explanation-step">
              <div className="title">
